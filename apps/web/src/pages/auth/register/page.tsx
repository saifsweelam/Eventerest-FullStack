        ...
        <div className="flex flex-col items-center justify-center h-screen">
            ...
            <form onSubmit={onSubmit} className="mt-6 w-full max-w-sm space-y-4">
                <div>
                    ...
                    <input type="text" id="name" name="name" required className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:ring-blue-500" />
                </div>
                <div>
