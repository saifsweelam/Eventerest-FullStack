                ...
                <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
                    ...
                    <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
                        ...
                        <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,var(--color-gray-200),var(--color-indigo-200),var(--color-gray-50),var(--color-indigo-300),var(--color-gray-200))] bg-[length:200%_auto] bg-clip-text pb-4 font-nacelle text-3xl font-semibold text-transparent md:text-4xl">
                            Everything you need to run your events smoothly
                        </h2>
                        <p className="text-lg text-indigo-200/65">
                            From ticket sales to venue insights, our platform handles the logistics so you can focus on creating unforgettable experiences.
                        </p>
                    </div>
                    <div
                    ...
                    <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
                        <article>
                            ...
                            <p className="text-indigo-200/65">
                                Set up single or multi-tiered ticket options, manage capacity, and track real-time sales with ease.
                            </p>
                        </article>
                        <article>
                            <svg className="mb-3 fill-indigo-500" xmlns="http://www.w3.org/2000/svg" width={24} height={24}>
                            ...
                            <p className="text-indigo-200/65">
                                Attendees and organizers get personalized dashboards for tickets, check-ins, and event insights.
                            </p>
                        </article>
                        <article>
                            <svg className="mb-3 fill-indigo-500" xmlns="http://www.w3.org/2000/svg" width={24} height={24}>
                            ...
                            <p className="text-indigo-200/65">
                                Let users find events by location, genre, availability, and more with our AI-powered search engine.
                            </p>
                        </article>
                        <article>
                            <svg className="mb-3 fill-indigo-500" xmlns="http://www.w3.org/2000/svg" width={24} height={24}>
                            ...
                            <p className="text-indigo-200/65">
                                Instantly alert users about ticket releases, changes, cancellations, and personalized recommendations.
                            </p>
                        </article>
                        <article>
                            <svg className="mb-3 fill-indigo-500" xmlns="http://www.w3.org/2000/svg" width={24} height={24}>
                            ...
                            <p className="text-indigo-200/65">
                                Host one-time, multi-day, or recurring events and let users choose the dates that suit them best.
                            </p>
                        </article>
                        <article>
                            <svg className="mb-3 fill-indigo-500" xmlns="http://www.w3.org/2000/svg" width={24} height={24}>
                            ...
                            <p className="text-indigo-200/65">
                                Automatically sync upcoming events to your calendar and never miss an experience.
                            </p>
                        </article>
                    </div>
                </div>
